  ...
  return (
    <div style={{ padding: '20px 16px', paddingBottom: 8 }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', top: -20, right: -20, width: 100, height: 100, borderRadius: '50%', background: '#B5593C', opacity: 0.15 }} />
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  aspectRatio: '1',
                  borderRadius: 8,
                  background: done ? '#B5593C' : isFuture ? '#EDEBE5' : '#FEE2E2',
                  border: isToday && !done ? '1.5px dashed #B5593C' : 'none',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                }}>
