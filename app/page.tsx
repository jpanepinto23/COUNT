...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#111110', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* ââ Hero âââ full-height video, centered brand + CTA ââ */}
      <div style={{ position: 'relative', overflow: 'hidden', background: '#0E0D0C', height: '60vw', minHeight: 340, maxHeight: 560 }}>
        ...
        {/* Intro cover — hides video title card, fades away automatically */}
      ...
      {/* ââ Headline + CTA ââââââââââââââââââââââââââââââââââââââââââ */}
      ...
      {/* ââ Differentiator hook âââââââââââââââââââââââââââââââââââ */}
          ...
          {COMPARISON.map(({ feature, count, others }, i) => (
            <div key={i} style={{ display: 'grid', gridTemplateColumns: '1fr 60px 60px', gap: 8, alignItems: 'center', padding: '11px 12px', background: i % 2 === 0 ? '#141413' : '#111110', borderRadius: 8 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                <span style={{ fontSize: 17, color: count ? '#5DBB63' : '#555' }}>{count ? 'â' : 'â'}</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'center' }}>
                {others === true
                  ? <span style={{ fontSize: 14, color: '#555' }}>~</span>
                  : <span style={{ fontSize: 14, color: '#3A3A38' }}>â</span>
                }
              </div>
            </div>
          ))}
      ...
      {/* ââ Tier preview ââââââââââââââââââââââââââââââââââââââââââââ */}
      <div style={{ padding: '40px 24px', borderTop: '1px solid #1C1C1B' }}>
      ...
      {/* ââ Partner Brands ââââââââââââââââââââââââââââââââââââââââââ */}
      ...
      {/* ââ Syncs With ââââââââââââââââââââââââââââââââââââââââââââââ */}
      <div style={{ padding: '36px 24px', background: '#0D0D0C', borderTop: '1px solid #1C1C1B' }}>
      ...
      {/* ââ Email Capture âââââââââââââââââââââââââââââââââââââââââââ */}
      <div style={{ padding: '40px 24px', borderTop: '1px solid #1C1C1B' }}>
